...
# detector channel to phase mappings file
map_file = pd.read_csv('MAPPINGS_DET_INFO_OCT_2022.csv')



# corridor for which to compute EOI's. All availale corridors should be in config.py
curr_corridor = 'RedBugLakeRd'
time_start ="2022-11-15 00:00:00"
time_end ="2022-12-15 00:00:00"

# path where the events are stored
